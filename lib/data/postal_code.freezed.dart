...
mixin _$PostalCodeAddress {
  String get prefcture => throw _privateConstructorUsedError;
...
class _$PostalCodeAddressCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      prefcture: prefcture == freezed
          ? _value.prefcture
          : prefcture // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_PostalCodeAddress
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PostalCodeAddress(prefcture: $prefcture, address1: $address1, address2: $address2, address3: $address3, address4: $address4)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('prefcture', prefcture))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.prefcture, prefcture) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(prefcture),
...
abstract class _PostalCodeAddress implements PostalCodeAddress {
  const factory _PostalCodeAddress(
      {required final String prefcture,
